...
export function PromotionNhBurningCare() {
  ...
  return (
    <div id="promo-nh-burning-care" className="promotion-nh-container bg-white font-sans text-slate-900 tracking-tight">
      <Script id="gtm-nh-burning-care" strategy="afterInteractive" dangerouslySetInnerHTML={{
        __html: `
      ...
      {pixelId && (
        <>
          <Script id="meta-pixel-nh-burning-care" strategy="afterInteractive" dangerouslySetInnerHTML={{
            __html: `
      ...
      <section className="w-full bg-black flex justify-center overflow-hidden">
        <div className="w-full max-w-7xl">
          ...
          <img
            src={encodeURI("/images/버닝케어캔바완벽수정-히어로.png")}
