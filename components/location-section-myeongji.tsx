...
export function LocationSectionMyeongji() {
  return (
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">0507-1427-0797</p>
                </div>
              </div>
